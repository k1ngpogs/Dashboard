export default function Qualitative({ ticker, analysis, loading, error }) {
  const sections = [
    ...
    { key: 'capital_allocation', title: 'Capital Allocation Track Record' },
    { key: 'insider_ownership', title: 'Insider Ownership & Incentives' },
    ...
    return (
      <div className="loading-container">
        ...
        <div className="loading-text">
          Researching {ticker} — this takes 30-60 seconds...
        </div>
      </div>
    );
  }
    ...
    <div>
      <div className="card">
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 13, marginBottom: 8 }}>
          AI-generated from current web sources. Verify critical facts independently.
        </p>
      </div>
